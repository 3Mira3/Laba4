				...
				<div class="container">
					...
					<div class="banner-grids">
						<div class="col-md-6 banner-grid">
							<h4>Activities</h4>
							<p>There are many interesting things here that will take you all day: animal feeding, shops with drinks and food, souvenirs specifically about this zoo.</p>
						</div>
						<div class="col-md-6 banner-grid">
						<h4>Choice of partners</h4>
							<p>You can come with children, with grandparents, boyfriends or girlfriends, the main thing is that the day will be unforgettable.</p>
						</div>
